...
suite "DNSCrypt":
  test "IPv4":
    ...
    let
      ...
      a = initDNSCryptStamp("164.68.121.162", Port(4443), "pryv8boi.org", pk, {StampProps.DNSSEC, StampProps.NoFilter, StampProps.NoLog})
  ...
  test "IPv6":
    ...
    let
      ...
      a = initDNSCryptStamp("2001:19f0:7402:1574:5400:2ff:fe66:2cff", Port(443), "v.dnscrypt.uk", pk, {StampProps.DNSSEC, StampProps.NoFilter, StampProps.NoLog})
...
suite "DoH":
  test "IPv4":
    ...
    let
      ...
      a = initDoHStamp("116.202.176.26", "doh.libredns.gr", Port(443), hashes, "/ads", @[], {StampProps.NoLog})
  ...
  test "IPv6":
    ...
    let
      ...
      a = initDoHStamp("2001:4860:4860::8888", "dns.google", Port(443), hashes, "/dns-query", @[], {StampProps.DNSSEC, StampProps.NoFilter})
...
suite "DoT":
  test "IPv4":
    ...
    let
      ...
      a = initDoTStamp("1.1.1.1", "one.one.one.one", Port(853), hashes, @[], {StampProps.DNSSEC, StampProps.NoFilter, StampProps.NoLog})
  ...
  test "IPv6":
    ...
    let
      ...
      a = initDoTStamp("2001:4860:4860::8888", "dns.google", Port(853), hashes, @[], {StampProps.DNSSEC, StampProps.NoFilter})
...
suite "DoQ":
  test "IPv4":
    ...
    let
      ...
      a = initDoQStamp("94.140.14.140", "dns-unfiltered.adguard.com", Port(853), hashes, @[], {StampProps.DNSSEC, StampProps.NoFilter, StampProps.NoLog})
  ...
  test "IPv6":
    ...
    let
      hashes = @[[0x9a.byte, 0x3a, 0x34, 0xf7, 0x27, 0xde, 0xb9, 0xbc, 0xa5, 0x10, 0x03, 0xd9, 0xce, 0x9c, 0x39, 0xf8, 0xf2, 0x7d, 0xd9, 0xc5, 0x24, 0x29, 0x01, 0xc2, 0xba, 0xb1, 0xa4, 0x4e, 0x63, 0x5a, 0x02, 0x19]]
      a = initDoQStamp("2a10:50c0::1:ff", "dns-unfiltered.adguard.com", Port(853), hashes, @[], {StampProps.DNSSEC, StampProps.NoFilter, StampProps.NoLog})
